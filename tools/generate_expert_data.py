...
if __name__ == '__main__':
    ...
    # python tools/generate_expert_data.py --model_path baselines/obstacle_200M_HN+FA_KL_3_wo_PE+dropout --data_path obstacle_200M_HN+FA_KL_3_wo_PE+dropout_16k*500 --mode MT --seed 1409 --agent_path data/train --num_env 16 --start 0 --end 500
    # ST
